...
if __name__ == "__main__":
    ...
    sheet = "SGD"
    xlsx_file = "data/summary/aSummary.xlsx"
    sgd_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
    ...
    sheet = "USD"
    xlsx_file = "data/summary/aSummary.xlsx"
    usd_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
    ...
    sheet = "Fund"
    xlsx_file = "data/summary/aSummary.xlsx"
    fund_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
    ...
    sheet = "SRS"
    xlsx_file = "data/summary/aSummary.xlsx"
    srs_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
    srs_df.to_csv("data/summary/portfolio_srs.csv")

    print("Generating portfolio_idr...")
    start_date = "2023-02-01"
    sheet = "IDR"
    xlsx_file = "data/summary/aSummary2.xlsx"
    idr_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
    ...
    sheet = "Bond"
    xlsx_file = "data/summary/aSummary.xlsx"
    bond_df = get_portfolio(end_date, start_date, sheet, xlsx_file)
